...
const rows = [
  createData(1, 'Service 1', 'Category 1'),
  createData(2, 'Service 2', 'Category 2'),
  createData(3, 'Service 3', 'Category 1'),
  createData(4, 'Service 4', 'Category 1'),
  createData(5, 'Service 5', 'Category 3'),
  createData(6, 'Service 6', 'Category 2'),
];
...
const headCells = [
  ...
  { id: 'name', numeric: false, disablePadding: false, label: 'Service Name' },
